...
PLAYER_IMAGE = pygame.image.load("blondegirlasset1.png")
PLAYER_IMAGE = pygame.transform.scale(PLAYER_IMAGE, (PLAYER_WIDTH, PLAYER_HEIGHT))
PLAYER_VEL = 12   # Speed at which the Player moves

# 11. Create Heart
HEART_WIDTH, HEART_HEIGHT = 60, 90
HEART_IMAGE = pygame.image.load("redpixelheart.png")
...
receive_sound = pygame.mixer.Sound("retro-coin-3-236679.mp3")
receive_sound.set_volume(0.1)

# 21. Create Menu
def menu():
    menu_bg = pygame.image.load("Snow game cover (2).png")
...
# 23: End Game Screen
def end_game_screen():
    end_game_screen = pygame.image.load("gameover.png")
...
# 24: Win Game Screen
def win_game_screen():
    win_game_screen = pygame.image.load("wincover.png")
...
# Sound for loop
    pygame.mixer.music.load("ifollowrivers.mp3")
...
# 20. If score reaches 0 (Game Over)
        if score == 0:
            ...
            pygame.mixer.music.load("stvalentin game end.mp3")
            pygame.mixer.music.play(1)
        ...
        if score >= 100000:
            pygame.mixer.music.stop()
            pygame.mixer.music.load("windoot-96335.mp3")
            pygame.mixer.music.play(1)
            ...
            pygame.mixer.music.load("wingamemessage.mp3")
            pygame.mixer.music.play(1)
